...
import type { Trajectoire } from "../models/trajectoire.model"
...
export class TrajectoireService {
  ...
  create(trajectoire: Partial<Trajectoire>): Observable<Trajectoire> {
    return this.http.post<Trajectoire>(this.apiUrl, trajectoire)
  }
}
